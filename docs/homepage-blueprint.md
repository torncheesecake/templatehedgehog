...
- Production-ready email system, not a folder of fragments.
...
4. Technical proof
   Show MJML source, compiled HTML, and archive structure.
...
- Paid archive feels complete, not partial.
