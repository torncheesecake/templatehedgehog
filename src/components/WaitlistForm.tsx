  ...
  return (
    <form onSubmit={handleSubmit} className={`flex w-full max-w-xl flex-col gap-3 sm:flex-row ${className}`}>
      ...
      <button
        ...
        className="h-12 rounded-[0.72rem] border border-[var(--action-primary)] bg-[var(--action-primary)] px-6 text-base font-semibold !text-[var(--action-text)] transition hover:bg-[var(--action-primary-hover)] disabled:cursor-not-allowed disabled:opacity-70"
      >
