        ...
        <article className="border-l-2 border-[rgba(111,71,37,0.46)] pl-4 sm:pl-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex h-10 items-center rounded-[0.8rem] border border-[var(--action-primary)] bg-[var(--action-primary)] px-4 text-[0.8rem] font-semibold uppercase tracking-[0.06em] !text-[var(--action-text)] transition hover:bg-[var(--action-primary-hover)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--action-primary)] focus-visible:ring-offset-2"
            >
              Copy MJML
            </button>
          </div>
