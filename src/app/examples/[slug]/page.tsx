        ...
        <article className={cn(VS.templates.content.body, VS.templates.content.heroCard)}>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex h-11 items-center rounded-[0.82rem] border border-[var(--action-primary)] bg-[var(--action-primary)] px-4 text-[0.92rem] font-semibold !text-[var(--action-text)] transition duration-200 hover:bg-[var(--action-primary-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--action-primary)] focus-visible:ring-offset-2"
            >
              Open workflow
            </Link>
            <Link
