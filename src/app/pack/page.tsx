        ...
        <div className="mx-auto w-full">
          ...
          <section className="mt-14 border-t border-black/10 pt-8">
            <div className="flex flex-wrap gap-3">
              <Link
                href="/pricing"
                className="inline-flex h-11 items-center rounded-[0.82rem] border border-rose-600 bg-rose-600 px-4 text-[0.9rem] font-semibold tracking-[0.01em] !text-slate-900 transition duration-200 hover:bg-rose-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2"
              >
                View pricing
              </Link>
              <Link
