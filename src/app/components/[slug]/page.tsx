          ...
          <article className="grid gap-8 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:items-center">
            <div>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Link
                  href="/pricing"
                  className="inline-flex h-11 items-center gap-2 rounded-[0.8rem] border border-rose-600 bg-rose-600 px-5 text-[1rem] font-semibold tracking-[0.01em] !text-slate-900 transition duration-200 hover:bg-rose-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-600 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                >
                  {`View ${MJML_PACK_NAME}`}
